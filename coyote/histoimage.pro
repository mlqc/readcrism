...
imagePos =    [0.15, 0.100, 0.95, 0.400]
   ...
   ; Calculate appropriate character size for plots. For the PRINTER device,
   ; always do CHARSIZE=0.

IF !D.Name EQ 'PRINTER' THEN thisCharsize = 0.0 ELSE thisCharsize = Str_Size('A Sample String', 0.20)
