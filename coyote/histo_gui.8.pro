PRO Histo_GUI_Image_Open, event

; This event handler loads a new image file.
...
Widget_Control, event.top, Get_UValue=info, /No_Copy
   ...
   ; What kind of event is this: button or image open?
...
openID = Widget_Button(fileID, Value='Open...', Event_Pro='Histo_GUI_Image_Open')
