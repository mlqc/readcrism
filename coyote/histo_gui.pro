...
HistoImage, *info.process, $
   ...
   YScale=info.yscale
WSet, info.wid
Device, Copy=[0, 0, !D.X_Size, !D.Y_Size, 0, 0, info.pixmapID]
...
IF thisEvent EQ 'WIDGET_BASE' THEN BEGIN
   ...
   WSet, info.wid
   Device, Copy=[0, 0, event.x, event.y, 0, 0, info.pixmapID]
...
Widget_Control, drawID, Get_Value=wid
   ...
   ; Create a pixmap window for "double buffering". This technique
   ; will avoid window flashing as graphics are redrawn in the window.

Window, XSize=400, YSize=400, /Pixmap, /Free
pixmapID = !D.Window

   ; Draw the graphic display in the pixmap.
